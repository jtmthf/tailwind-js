...
export const p = (key: string | number) => (theme: Theme) =>
  css({ padding: theme.padding[key] });
export const pt = (key: string | number) => (theme: Theme) =>
  css({ paddingTop: theme.padding[key] });
export const pr = (key: string | number) => (theme: Theme) =>
  css({ paddingRight: theme.padding[key] });
export const pb = (key: string | number) => (theme: Theme) =>
  css({ paddingBottom: theme.padding[key] });
export const pl = (key: string | number) => (theme: Theme) =>
  css({ paddingLeft: theme.padding[key] });
